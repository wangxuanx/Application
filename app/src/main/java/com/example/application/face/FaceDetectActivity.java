...
import com.example.application.face.utils.Base64Util;
import com.example.application.face.utils.ImageSaveUtil;
import com.example.application.face.utils.Md5;
import com.example.application.face.widget.BrightnessTools;
import com.example.application.face.widget.FaceRoundView;
import com.example.application.face.widget.WaveHelper;
import com.example.application.face.widget.WaveView;
...
public class FaceDetectActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_detected);
    ...
    private void initView() {
        ...
        faceDetectManager.setOnFaceDetectListener(new FaceDetectManager.OnFaceDetectListener() {
            ...
            public void onDetectFace(final int retCode, FaceInfo[] infos, ImageFrame frame) {
                /*
                可以检测得到人脸信息FaceInfo,retCode为人脸检测值，，ImageFrame为相机返回的预览图片，
                一般为0的时候表示合格人脸图片，可用这时候的图片进行人脸注册、登录等事宜。亦可如后描述7在onTrack中取图片进行。
                 */
...
//                Color.parseColor("#3cf16d7a"));
    ...
    private boolean saveFaceBmp(FaceFilter.TrackedModel model) {        //保存采集的人脸照片
        ...
        if (face != null) {
            ...
            SharedPrefUtil.setParam(this, SharedPrefUtil.FACE_STATE, true);               //保存人脸是否注册信息
            System.out.println("人脸状态："+SharedPrefUtil.getFaceState(this));
        }
