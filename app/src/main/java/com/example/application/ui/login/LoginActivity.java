            ...
            Login.setOnClickListener(new View.OnClickListener() {     //登录按钮事件
                ...
                public void onClick(View view) {
                    ...
                    if (username.equals("") || password.equals("")){
                        ...
                        System.out.println(Md5.MD5(password, "utf-8"));        //加密密码送往服务器

                        /**登录腾讯IM*/
                        TIMManager.getInstance().login(username, GenerateTestUserSig.genTestUserSig(username.toString().trim()), new TIMCallBack() {
                            @Override
